...
### Provider Choice: Google Gemini 1.5 Pro
Native multi-modality. It can process the Broad Bioimage sets and the Pes2oX text in the same context window without needing separate vision encoders like CLIP.
